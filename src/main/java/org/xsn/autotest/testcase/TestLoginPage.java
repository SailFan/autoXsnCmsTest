...
public class TestLoginPage {
	...
	public void testErrorPassword() {
		...
		page.myDDwait(10).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".el-message.el-message--error p")));
	...
	public void testUserNameNonExistent() {
		...
		page.myDDwait(10).until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".el-message.el-message--error p")));
...
//	验证最大用户名输入
	...
	public void testCheckMaxUserNameInput() {
		String userName = "Adminafdafasfsdafssdafdsafsdafsafasfasafsdafsaf";
		LoginPage page = new LoginPage(brower);
		page.loginToXsn(userName, "");
		String nameValue = page.getUserNameValue();
		Assert.assertEquals(nameValue.length(), "15");
	}
